...
- **📊 Dashboard**     — Today's summary, an animated 7-day bar chart, a daily goal ring and recent workout list.
- **➕ Log Workout**   — Form to log exercise name, type, duration, calories, steps and notes.
